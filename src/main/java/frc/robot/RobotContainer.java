...
public class RobotContainer {
    ...
    private final SwerveInputStream driveAngularVelocity = SwerveInputStream.of(swerveSubsystem.getSwerveDrive(),
            () -> -driverController.getLeftY() * (driverController.leftTrigger().getAsBoolean() ? DriveConstants.FAST_SCALE : 1) * (driverController.rightTrigger().getAsBoolean() ? DriveConstants.SLOW_SCALE : 1),
            () -> -driverController.getLeftX() * (driverController.leftTrigger().getAsBoolean() ? DriveConstants.FAST_SCALE : 1) * (driverController.rightTrigger().getAsBoolean() ? DriveConstants.SLOW_SCALE : 1))
